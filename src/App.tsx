      ...
      <div className="p-6 flex flex-col h-full mt-2">
        ...
        <div className="flex gap-1.5 md:gap-2 mt-auto" onPointerDown={e => e.stopPropagation()}>
          <button
            ...
            className="flex-[2] bg-blue-600 hover:bg-blue-700 text-white py-2 md:py-3 px-2 md:px-4 rounded-xl md:rounded-2xl font-bold shadow-lg shadow-blue-100 transition-all active:scale-95 flex items-center justify-center gap-1.5 md:gap-2 text-[11px] md:text-sm whitespace-nowrap"
          >
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-3 md:gap-4 mb-4 md:mb-6 bg-white p-3 md:p-4 rounded-2xl border border-slate-200">
          ...
          <div className="flex flex-col md:flex-row items-center gap-3 md:gap-6 w-full md:w-auto">
            ...
            <div className="flex gap-2 w-full md:w-auto">
              <button onClick={() => setCurrentView('timetable')} className="flex-1 md:flex-none px-3 md:px-4 py-2 bg-blue-600 text-white rounded-lg md:rounded-xl text-[10px] md:text-sm font-bold shadow-md shadow-blue-100">주간보기</button>
              <button onClick={() => setCurrentView('list')} className="flex-1 md:flex-none px-3 md:px-4 py-2 bg-slate-100 text-slate-600 rounded-lg md:rounded-xl text-[10px] md:text-sm font-bold border border-slate-200">홈으로</button>
            </div>
          </div>
        </div>
    ...
    return (
      <div className="p-2 md:p-4 max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row items-center justify-between gap-3 md:gap-4 mb-4 md:mb-6 bg-white p-3 md:p-4 rounded-2xl border border-slate-200 text-center">
          ...
          <div className="flex flex-col md:flex-row items-center gap-3 md:gap-6 w-full md:w-auto">
            <div className="flex items-center gap-3 md:gap-4 bg-slate-50 p-1 rounded-xl md:bg-transparent md:p-0">
            ...
            <button onClick={() => setCurrentView('list')} className="w-full md:w-auto px-4 md:px-6 py-2 bg-slate-900 text-white rounded-lg md:rounded-xl text-[10px] md:text-sm font-bold shadow-md shadow-slate-200 transition-all active:scale-[0.98]">목록으로</button>
          </div>
        </div>
